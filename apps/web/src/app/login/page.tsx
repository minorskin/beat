  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4">
      <form action={login} className="panel p-5 sm:p-6 w-full max-w-xs">
        <h1 className="t-kpi font-semibold mb-1">Beat</h1>
        <p className="t-body mb-4" style={{ color: 'var(--muted)' }}>Portföyüne erişmek için şifre gir</p>
        <input name="password" type="password" autoFocus placeholder="Şifre" className="field mb-3" />
        {err && <p className="t-body mb-3" style={{ color: 'var(--down)' }}>Yanlış şifre</p>}
